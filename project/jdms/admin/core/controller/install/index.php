...
// Confirm file exist
if (file_exists($this->users_file_path)) { // user_file_path is defined in parent file
  // Get user data
  $user_data = json_decode(file_get_contents($this->users_file_path), true);
  // Check if any users exist
  if (count($user_data['users'])) {
    // Update flag
    $users_exist = true;
  }
}
...
?>
<link rel="stylesheet" content="text/css;" href="/jdms/admin/core/controller/install/assets/css/install.css"/>
<div class="container">
  <form class="ui-install-panel" method="post">
    ...
    <?php } ?>
    <input type="hidden" name="initializejaydms" value="true"/>
    <div class="ui-card">
      <div class="ui-card__title">
        <h3>Configuration</h3>
      </div>
      <div class="row">
        <div class="col-12 col-sm-6">
          <div class="form-group">
            <label for="SaltKey">Salt for Encryption</label>
            <input id="SaltKey" name="salt" type="text" class="form-control" value="<?php echo (isset($_POST['salt']) ? $_POST['salt'] : "");?>" required/>
          </div>
        </div>
        <div class="col-12 col-sm-6">
          <div class="form-group">
            ...
            <select id="Timezone" name="timezone" class="form-control" required>
              <option value="<?php echo (isset($_POST['timezone']) ? $_POST['timezone'] : "");?>">Select Timezone</option>
      ...
      <?php if (!$users_exist) { ?>
        <input type="hidden" name="initializeusers" value="true"/>
        <div class="ui-card__title">
          <h3>Admin Account</h3>
        </div>
        <div class="row">
          <div class="col-12 col-sm-6">
            <div class="form-group">
              ...
              <input id="FirstName" name="firstname" type="text" class="form-control" value="<?php echo (isset($_POST['firstname']) ? $_POST['firstname'] : "");?>" placeholder="John" required/>
            </div>
          </div>
          <div class="col-12 col-sm-6">
            <div class="form-group">
              <label for="LastName">Last Name</label>
              <input id="LastName" name="lastname" type="text" class="form-control" value="<?php echo (isset($_POST['lastname']) ? $_POST['lastname'] : "");?>" placeholder="Doe" required/>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-12 col-sm-6">
            <div class="form-group">
              ...
              <input id="Username" name="username" type="text" class="form-control" value="<?php echo (isset($_POST['username']) ? $_POST['username'] : "");?>" placeholder="JohnDoe123" required/>
            </div>
          </div>
          <div class="col-12 col-sm-6">
            <div class="form-group">
              <label for="Email">Email</label>
              <input id="Email" name="email" type="text" class="form-control" value="<?php echo (isset($_POST['email']) ? $_POST['email'] : "");?>" placeholder="your@email.com" required/>
            </div>
          </div>
          <div class="col-12 col-sm-6">
            <div class="form-group">
    ...
    <div class="text-center">
      <button class="btn btn-xl ui-btn" type="submit">Initialize JayDMS</button>
    </div>
  </form>
</div>