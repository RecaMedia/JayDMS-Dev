...
export default class InputCode extends React.Component {
  ...
  render() {
    return (
      <Editor mode="html" width="100%" height="160px" theme="light" code={this.state.value} component={{fields:[]}} componentSlug={""} onChange={(code) => this._onChange(code)} shortMenu={false} leaveBlank={true}/>
    );
  }
}
