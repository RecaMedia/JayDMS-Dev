    ...
    return (
      <div>
        {(this.props.shortMenu ? 
          <Curtain show={this.state.showShortcodes} toggle={this._toggleShortcode}>
            <ShortMenu toggle={this._toggleShortcode} insert={this._replace}/>
          </Curtain>
        : null)}
        ...
        {(this.props.shortMenu ? 
          <button className="btn ui-btn ui-btn--shortcode" onClick={() => this._toggleShortcode(true)}><i className="icon ion-md-code-download"></i></button>
        : null)}
      </div>
    );
  }
