...
import InputComponents from '../inputs/components';
    ...
    let ui_fields = <div>
      {
        keys.map((key, i) => {
          ...
          switch (form[key].input) {
            ...
            break;
            case "components" :
              input = <InputComponents key={i} useKey={has_multiple_keys} index={i} inputKey={key} value={value} options={form[key].options} returnValue={this._handleValue}/>
            break;
            case "datetime" :
            ...
            break;
            case "file" :
              input = <InputFile key={i} useKey={has_multiple_keys} index={i} inputKey={key} value={value} options={form[key].options} returnValue={this._handleValue}/>
            break;
            case "code" :
