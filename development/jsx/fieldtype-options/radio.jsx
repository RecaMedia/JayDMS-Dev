...
export default class RadioFunc extends React.Component {
  ...
  render() {
    return <div className="ui-fieldtype__form-content__extras ui-fieldtype__form-content__extras--radio">
      <div className="row">
