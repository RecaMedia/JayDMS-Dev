...
class DirectoryLister {
     ...
     * @access public
     */
    public function listDirectory($directory,$omit_path = null) {

        if ($omit_path != null) {
            $this->_omitPath = $omit_path;
        }
                ...
                if (!$this->_isHidden($relativePath)) {
                    ...
                    if ($this->_directory != '.' || $file != 'index.php') {
                        ...
                        $directoryArray[pathinfo($relativePath, PATHINFO_BASENAME)] = array(
                            ...
                            'url_path'   => $urlPath,
                            'permission' => @substr(sprintf('%o', fileperms($relativePath)), -4),
    ...
    protected function _isHidden($filePath) {
        ...
        foreach ($this->_config['hidden_files'] as $hiddenPath) {
            ...
            if (fnmatch($hiddenPath, $filePath) && !fnmatch($hiddenPath, $this->_omitPath)) {
